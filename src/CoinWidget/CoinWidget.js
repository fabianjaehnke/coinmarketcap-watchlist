          ...
          <div className="coinwidget-inner">
            ...
            <div className="coinwidget--right">
              ...
              <div className="price-default">
                <div className="h3">
                  <strong>$</strong> {this.calculateDigits(coin.price_usd)}
                </div>
              ...
              <div style={shown} className="coindetails">
                <div className="h3">
                  <strong>€</strong> {this.calculateDigits(coin.price_eur)}
                </div>
                <div className="h3">
                  <span className="btc">BTC</span>{" "}
                  {this.calculateDigits(coin.price_btc)}
                </div>
                <br />
                ...
                <br />
                <span>
                  <small>updated: {`${hours}:${minutes}:${seconds}`}</small>
                </span>
                <div style={shown} className="button-delete">
                  <IconButton>
                    <ActionRemoveCircleOutline onClick={this.removeWidget} />
                  </IconButton>
                </div>
              </div>
            </div>
